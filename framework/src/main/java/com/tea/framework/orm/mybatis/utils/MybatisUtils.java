 ...
 * 修改内容：新增
 */
package com.tea.framework.orm.mybatis.utils;
...
public class MybatisUtils {
    ...
    public static MappedStatement createMappedStatement(MappedStatement ms, SqlSource sqlSource, String newMsId, MappingEnum mappingType) {
        String id = newMsId;//ms.getId() + cacheSuffixKey;
